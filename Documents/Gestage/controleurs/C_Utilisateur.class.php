...
class C_Utilisateur extends Controleur{
    ...
    function ajoutStageEtapeEntreprise(){
      ...
      function validerAjoutStage(){
        ...
        $lesOrganisations = new M_ListeEntreprise();
        $uneOrganisation = $lesOrganisations->get($_POST["choixEntrepriseStage"]);
        
        // préparer la liste des paramètres
        $lesParametres = array();
        // récupérer les données du formulaire
        $lesParametres["ANNEESCOL"] = $_POST["AnneeScol"];
        $lesParametres["IDETUDIANT"] = $_POST["eleveId"];
        $lesParametres["IDPROFESSEUR"] = $_POST["Professeur"];
        $lesParametres["IDORGANISATION"] = $_POST["choixEntrepriseStage"];
        $lesParametres["IDMAITRESTAGE"] = $_POST["choixMaitreStage"]; 
        $lesParametres["DATEDEBUT"] = $_POST["dateDeb"]; 
        $lesParametres["DATEFIN"] = $_POST["dateFin"]; 
        $lesParametres["VILLE"] = $uneOrganisation->VILLE_ORGANISATION; 
